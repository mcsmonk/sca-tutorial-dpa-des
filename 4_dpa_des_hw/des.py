...
Functions and tables for DES

Most of tables from https://gist.github.com/Xpktro/6549868
...
class DES(object):
    ...
    def permute(self, data, table):
        buf = np.zeros((len(table),), dtype = np.uint8)
    ...
    def ks(self, k):
        ...
        for i, j in enumerate(self.PC_1):
            buf[i] = keybits[j-1]
        ...
        for r in range(16):
            ...
            for i, j in enumerate(self.PC_2):
                buf[i] = keybits[j-1]
